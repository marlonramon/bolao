...
CREATE  TABLE IF NOT EXISTS `Bolao` (
  ...
  `pontosAcertoDoisPlacares` INT(3) NULL ,
  `pontosAcertoUmPlacar` INT(3) NULL ,
  `pontosAcertoResultado` INT(3) NULL ,
...
ALTER TABLE campeonato add imagem varchar(200);
ALTER TABLE CAMPEONATO ADD ATIVO TINYINT NOT NULL default 0;
